...
public class SysUser extends BaseSysUser<SysUser> {
	...
	public Page<Record> getPage(int pnum,int psize, String orgid,String usernameSearch,String nameSearch){
		String sql  = " from sys_user u LEFT JOIN sys_org o  on o.id = u.orgid  where 1=1  and u.status='1' ";
		if(!ShiroKit.getLoginUser().getUsername().equals("lion")){
			sql = sql + " and u.username !='"+Constants.SUUUUUUUUUUUUUPER_USER_NAME+"' and u.username not in ('show','tdog','developor','moa') ";
	...
	/*	if(!ShiroKit.getLoginUser().getUsername().equals("show")||!ShiroKit.getLoginUser().getUsername().equals("tdog")||!ShiroKit.getLoginUser().getUsername().equals("developor")){
			sql = sql + " and u.username not in ('show','tdog','developor') ";
		}*/
	...
	public List<SysUser> getUserByOrgidAndRoleKey2(String orgid,String key){
		...
		if(list==null||list.size()==0){
			...
			if(org!=null&&!Constants.SYS_MENU_ROOT.equals(org.getParentId())){
