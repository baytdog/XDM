...
public abstract class BaseAmsAssetAllot<M extends BaseAmsAssetAllot<M>> extends Model<M> implements IBean {
	...
	public void setAllotToOrgId(java.lang.String allotToOrgId) {
		set("allot_to_org_id", allotToOrgId);
	}
	
	public java.lang.String getAllotToOrgId() {
		return getStr("allot_to_org_id");
	}

	public void setAllotToOrgName(java.lang.String allotToOrgName) {
		set("allot_to_org_name", allotToOrgName);
	}
	
	public java.lang.String getAllotToOrgName() {
		return getStr("allot_to_org_name");
	}
