...
public abstract class BaseOaApplyUserRegular<M extends BaseOaApplyUserRegular<M>> extends Model<M> implements IBean {
	...
	public void setUserWorkDes(java.lang.String userWorkDes) {
		set("user_work_des", userWorkDes);
	}
	
	public java.lang.String getUserWorkDes() {
		return getStr("user_work_des");
	}

	public void setHrMessage(java.lang.String hrMessage) {
		set("hr_message", hrMessage);
	}
	
	public java.lang.String getHrMessage() {
		return getStr("hr_message");
	}
