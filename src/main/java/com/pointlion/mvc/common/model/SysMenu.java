...
public class SysMenu extends BaseSysMenu<SysMenu> {
	...
	public List<SysMenu> getChildrenByPid(String id){
		...
		if(userName.equals("lion")||userName.equals("moa")) {
			
			return SysMenu.dao.find("select * from sys_menu m where m.parent_id='"+id+"' order by m.sort");
		}else{
			
			return SysMenu.dao.find("select * from sys_menu m where m.parent_id='"+id+"'  and if_show='1' order by m.sort");
		}
	...
	public List<SysMenu> getAllMenu(){
		List<SysMenu> list =  getChildrenAll(Constants.SYS_MENU_ROOT);
		return list;
	}
	/***
	 * 递归
