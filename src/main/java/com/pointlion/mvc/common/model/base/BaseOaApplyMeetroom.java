...
public abstract class BaseOaApplyMeetroom<M extends BaseOaApplyMeetroom<M>> extends Model<M> implements IBean {
	...
	public void setMeetRoomId(java.lang.String meetRoomId) {
		set("meet_room_id", meetRoomId);
	}
	
	public java.lang.String getMeetRoomId() {
		return getStr("meet_room_id");
	}
