...
public abstract class BaseAmsAssetBorrow<M extends BaseAmsAssetBorrow<M>> extends Model<M> implements IBean {
	...
	public void setGiveBackDes(java.lang.String giveBackDes) {
		set("give_back_des", giveBackDes);
	}
	
	public java.lang.String getGiveBackDes() {
		return getStr("give_back_des");
	}
	...
	public void setIfBack(java.lang.String ifback) {
		set("if_back", ifback);
	}
	
	public java.lang.String getIfBack() {
		return getStr("if_back");
	}
