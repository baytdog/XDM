...
public class Constants {
	...
	public static final String ADMIN_USER="admin,show";
	
	public static final String  RECEIVEDOCSEARCH="shenshuqiong";
	
	public static final String  DEPARTHOME="admin,tangzhaohui";
...
//	数据权限--老版本的数据权限，代码可以保留，建议不用
	 ...
	 * 菜单根目录
	 */
	public static final String SYS_MENU_ROOT = "root";
}
