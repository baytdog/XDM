package com.pointlion.mvc.admin.xdm.xdschoolinfo;
...
import com.pointlion.mvc.common.model.XdSchoolinfo;
...
public class XdSchoolinfoController extends BaseController {
	public static final XdSchoolinfoService service = XdSchoolinfoService.me;
     ...
     */
    public void save(){
    	XdSchoolinfo o = getModel(XdSchoolinfo.class);
...
//    	}
    ...
    public void getEditPage(){
		...
		setAttr("view", view);
		XdSchoolinfo o = new XdSchoolinfo();
...
//			o.setApplyerName(user.getName());
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdSchoolinfo.class.getSimpleName()));
