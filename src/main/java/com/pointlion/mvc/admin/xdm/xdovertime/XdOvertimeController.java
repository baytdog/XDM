...
public class XdOvertimeController extends BaseController {
	public static final XdOvertimeService service = XdOvertimeService.me;
	public static final String STYPE="4";
	/***
	 * get list page
	 */
     ...
     */
    public void save(){
    	XdOvertime o = getModel(XdOvertime.class);
		XdOvertime overtime = XdOvertime.dao.findById(o.getId());
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
		setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdOvertime.class.getSimpleName()));
	...
	/**
	 * @Method getHomeOvertimeListPage
	 * @Date 2023/1/15 10:18
	 * @Description 获取首页加班申请列表
	 * @Author king
	 * @Version  1.0
	 * @Return void
	 */
	public void getHomeOvertimeListPage(){
	 ...
	 * @Return void
	 */
	public void getHomeOvertimeList(){
		String curr = getPara("pageNumber");
		String pageSize = getPara("pageSize");
		String endTime = getPara("endTime","");
		String startTime = getPara("startTime","");
	  ...
	  * @Return void
	  */
	public void openHomeOvertimePage(){
		...
		XdOvertime o = XdOvertime.dao.findById(oid);
		o.getCreateUser();
		...
		setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdOvertime.class.getSimpleName()));//模型名称
		renderIframe("homeEdit.html");
	}

 	/**
 	 * @Method apprPass
 	 * @Date 2023/1/15 10:22
 	 * @Description  审批通过
 	 * @Author king
 	 * @Version  1.0
 	 * @Return void
	...
	public void apprPass(){
		...
		XdOvertime overtime = XdOvertime.dao.findById(oid);
