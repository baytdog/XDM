...
public class XdAnleavePlanController extends BaseController {
	public static final XdAnleavePlanService service = XdAnleavePlanService.me;
	/***
	 * get list page
	 */
     ...
     */
    public void save(){
    	XdAnleavePlan o = getModel(XdAnleavePlan.class);
    	renderSuccess();
    }
    /***
     * edit page
    ...
    public void getEditPage(){
		...
		setAttr("view", view);
		XdAnleavePlan o = new XdAnleavePlan();
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdAnleavePlan.class.getSimpleName()));
