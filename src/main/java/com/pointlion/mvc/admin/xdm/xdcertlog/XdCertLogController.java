...
public class XdCertLogController extends BaseController {
	public static final XdCertLogService service = XdCertLogService.me;
     ...
     */
    public void save(){
    	XdCertLog o = getModel(XdCertLog.class);
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdCertLog.class.getSimpleName()));
