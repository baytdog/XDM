...
public class XdSchoolinfoService{
	public static final XdSchoolinfoService me = new XdSchoolinfoService();
	public static final String TABLE_NAME = XdSchoolinfo.tableName;
