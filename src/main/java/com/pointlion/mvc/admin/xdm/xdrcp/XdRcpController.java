...
public class XdRcpController extends BaseController {
	public static final XdRcpService service = XdRcpService.me;
	public static final String STYPE="6";
	/***
	 * get list page
	 */
     ...
     */
    public void save(){
    	XdRcp o = getModel(XdRcp.class);
		XdRcp rcp = XdRcp.dao.findById(o.getId());
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
		setAttr("formModelName",StringUtil.toLowerCaseFirstOne(XdRcp.class.getSimpleName()));
	 ...
	 * @Return void
	 */
	public void getHomeRcpListPage(){
		renderIframe("homeList.html");
	}
	/**
	 * @Method getHomeRcpList
	 * @Date 2023/1/15 16:16
	 * @Description 获取首页列表数据
	 * @Author king
	 * @Version  1.0
	 * @Return void
	 */
	public void getHomeRcpList(){
		String curr = getPara("pageNumber");
		String pageSize = getPara("pageSize");
	 ...
	 /**
	  * @Method openHomeRcpPage
	  * @Date 2023/1/15 16:17
	  * @Description 打开首页rcp页面
	  * @Author king
	  * @Version  1.0
	  * @Return void
	  */
	public void openHomeRcpPage(){
		...
		XdRcp o = XdRcp.dao.findById(oid);
		o.getCreateUser();
	...
	public void apprPass(){
		...
		XdRcp overtime = XdRcp.dao.findById(oid);
