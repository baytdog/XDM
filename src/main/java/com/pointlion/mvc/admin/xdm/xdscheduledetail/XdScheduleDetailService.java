package com.pointlion.mvc.admin.xdm.xdscheduledetail;
...
public class XdScheduleDetailService{
	public static final XdScheduleDetailService me = new XdScheduleDetailService();
	public static final String TABLE_NAME = XdScheduleDetail.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		XdScheduleDetail o = me.getById(id);
    		o.delete();
    	}
	}
