...
public class CrmCustomerCompanyController extends BaseController {
	public static final CrmCustomerCompanyService service = CrmCustomerCompanyService.me;
    ...
    public void listData(){
    	...
    	Page<Record> page = service.getPage(Integer.valueOf(curr),Integer.valueOf(pageSize),startTime,endTime,companyName);
     ...
     */
    public void save(){
    	CrmCustomerCompany o = getModel(CrmCustomerCompany.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){
    		CrmCustomerCompany o = service.getById(id);
    		setAttr("o", o);
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(CrmCustomerCompany.class.getSimpleName()));
