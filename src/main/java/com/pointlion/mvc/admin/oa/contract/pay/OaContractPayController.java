package com.pointlion.mvc.admin.oa.contract.pay;
...
import com.pointlion.mvc.common.model.OaContractPay;
...
public class OaContractPayController extends BaseController {
	public static final OaContractPayService service = OaContractPayService.me;
     ...
     */
    public void save(){
    	OaContractPay o = getModel(OaContractPay.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaContractPay o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaContractPay.class.getSimpleName()));//模型名称
