package com.pointlion.mvc.admin.oa.apply.userdimission;
...
import com.pointlion.mvc.common.model.OaApplyUserDimission;
...
public class OaApplyUserDimissionController extends BaseController {
	public static final OaApplyUserDimissionService service = OaApplyUserDimissionService.me;
     ...
     */
    public void save(){
    	OaApplyUserDimission o = getModel(OaApplyUserDimission.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyUserDimission o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyUserDimission.class.getSimpleName()));//模型名称
