...
public class OaStepsService{
	public static final OaStepsService me = new OaStepsService();
	public static final String TABLE_NAME = OaSteps.tableName;
