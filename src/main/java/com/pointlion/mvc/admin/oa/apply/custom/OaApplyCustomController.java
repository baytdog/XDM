...
public class OaApplyCustomController extends BaseController {
	public static final OaApplyCustomService service = OaApplyCustomService.me;
    ...
    public void save(){
    	...
    	setAttr("defKey", defKey);
    	OaApplyCustom o = getModel(OaApplyCustom.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyCustom o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyCustom.class.getSimpleName()));//模型名称
    ...
    public void startProcess(){
    	...
    	String insId = wfservice.startProcess(id, o,defKey,null,null);
