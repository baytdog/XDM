package com.pointlion.mvc.admin.oa.steps;
...
public class OaStepsController extends BaseController {
	public static final OaStepsService service = OaStepsService.me;
     ...
     */
    public void save(){
    	OaSteps o = getModel(OaSteps.class);
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaSteps.class.getSimpleName()));
