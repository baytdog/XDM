package com.pointlion.mvc.admin.oa.qchoice;
...
public class OaQchoiceService{
	public static final OaQchoiceService me = new OaQchoiceService();
	public static final String TABLE_NAME = OaQchoice.tableName;
	...
	public Page<Record> getPage(int pnum,int psize,String qid){
		String userId = ShiroKit.getUserId();
		String sql  = " from "+TABLE_NAME+" o   where 1=1";
		//sql = sql + SysRoleOrg.dao.getRoleOrgSql(userId) ;
		 
		if(StrKit.notBlank(qid)){
			sql = sql + " and o.qid ='"+qid+"'";
		}
		sql = sql + " order by o.qchoice desc";
		return Db.paginate(pnum, psize, " select * ", sql);
	}
