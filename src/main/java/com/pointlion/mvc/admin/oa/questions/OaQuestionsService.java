package com.pointlion.mvc.admin.oa.questions;
...
public class OaQuestionsService{
	public static final OaQuestionsService me = new OaQuestionsService();
	public static final String TABLE_NAME = OaQuestions.tableName;
	...
	public Page<Record> getPage(int pnum,int psize,String tid){
		String sql  = " from "+TABLE_NAME+" o   where 1=1";
		//sql = sql + SysRoleOrg.dao.getRoleOrgSql(userId) ;
		if(StrKit.notBlank(tid)){
			sql = sql + " and o.testid='"+ tid+"'";
		}
		 
		sql = sql + " order by o.sortnum asc";
		return Db.paginate(pnum, psize, " select * ", sql);
	}
