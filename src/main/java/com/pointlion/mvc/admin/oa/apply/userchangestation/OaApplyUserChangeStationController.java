...
public class OaApplyUserChangeStationController extends BaseController {
	public static final OaApplyUserChangeStationService service = OaApplyUserChangeStationService.me;
     ...
     */
    public void save(){
    	OaApplyUserChangeStation o = getModel(OaApplyUserChangeStation.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyUserChangeStation o = service.getById(id);
    		setAttr("o", o);
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyUserChangeStation.class.getSimpleName()));//模型名称
