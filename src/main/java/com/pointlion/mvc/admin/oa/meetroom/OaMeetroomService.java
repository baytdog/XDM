...
public class OaMeetroomService{
	public static final OaMeetroomService me = new OaMeetroomService();
	public static final String TABLE_NAME = OaMeetroom.tableName;
