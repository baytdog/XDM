...
public class OaTabFileService{
	public static final OaTabFileService me = new OaTabFileService();
	public static final String TABLE_NAME = OaTabFile.tableName;
