package com.pointlion.mvc.admin.oa.apply.officeobjectbuy;
...
import com.pointlion.mvc.common.model.OaApplyOfficeObjectBuy;
...
public class OaApplyOfficeObjectBuyController extends BaseController {
	public static final OaApplyOfficeObjectBuyService service = OaApplyOfficeObjectBuyService.me;
     ...
     */
    public void save(){
    	OaApplyOfficeObjectBuy o = getModel(OaApplyOfficeObjectBuy.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){
    		OaApplyOfficeObjectBuy o = service.getById(id);
    		setAttr("o", o);
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyOfficeObjectBuy.class.getSimpleName()));
