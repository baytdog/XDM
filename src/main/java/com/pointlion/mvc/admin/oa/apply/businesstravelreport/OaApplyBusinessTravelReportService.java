...
public class OaApplyBusinessTravelReportService{
	public static final OaApplyBusinessTravelReportService me = new OaApplyBusinessTravelReportService();
	public static final String TABLE_NAME = OaApplyBusinessTravelReport.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		OaApplyBusinessTravelReport o = me.getById(id);
    		o.delete();
    	}
	}
