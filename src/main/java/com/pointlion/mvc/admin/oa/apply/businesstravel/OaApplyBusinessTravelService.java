package com.pointlion.mvc.admin.oa.apply.businesstravel;
...
public class OaApplyBusinessTravelService{
	public static final OaApplyBusinessTravelService me = new OaApplyBusinessTravelService();
	public static final String TABLE_NAME = OaApplyBusinessTravel.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		OaApplyBusinessTravel o = me.getById(id);
    		o.delete();
    	}
	}
