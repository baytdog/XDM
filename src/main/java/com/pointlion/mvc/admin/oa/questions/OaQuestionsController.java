...
public class OaQuestionsController extends BaseController {
	public static final OaQuestionsService service = OaQuestionsService.me;
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaQuestions.class.getSimpleName()));
