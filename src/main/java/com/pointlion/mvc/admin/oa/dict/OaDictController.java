...
public class OaDictController extends BaseController {
	public static final OaDictService service = OaDictService.me;
     ...
     */
    public void save(){
    	OaDict o = getModel(OaDict.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		...
    		setAttr("o", o);
    		OaDictGroup group = OaDictGroup.dao.getById(o.getGroupId());
    		if(group!=null){
    			setAttr("group",group);
    		}
    	}else{
    		String groupId = getPara("groupId");
    		OaDictGroup group = OaDictGroup.dao.getById(groupId);
    		if(group==null){
    			group = new OaDictGroup();
    			group.setId("");
    			group.setName("");
    		}
    		setAttr("group",group);
    	}
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaDict.class.getSimpleName()));//模型名称
    ...
    public void getDctGroupTree(){
		List<OaDictGroup> groupList = service.getChildrenAllTree(Constants.SYS_MENU_ROOT);
    ...
    public void getEditGroupPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		...
    		setAttr("o", o);
    		OaDictGroup group = OaDictGroup.dao.getById(o.getParentId());
    		if(group!=null){
    			setAttr("group",group);
    		}
    	}else{
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaDictGroup.class.getSimpleName()));//模型名称
    ...
    public void saveGroup(){
    	OaDictGroup o = getModel(OaDictGroup.class);
    	if(StrKit.notBlank(o.getId())){
    		o.update();
    	}else{
    		o.setId(UuidUtil.getUUID());
    ...
    public void deleteGroup(){
    	String groupId = getPara("groupId");
    	List<OaDict> list = OaDict.dao.getDctByGroupId(groupId);
    	List<OaDictGroup> groupList = OaDict.dao.getGroupListByParentId(groupId);
