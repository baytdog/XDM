...
public class OaProjectBuildController extends BaseController {
	public static final OaProjectBuildService service = OaProjectBuildService.me;
    ...
    public void save(){
    	...
    	if(StrKit.notBlank(o.getId())){
    		...
    		String buildid = UuidUtil.getUUID(); 
    		o.setId(buildid);
