...
public class OaApplyBorrowMoneyService{
	public static final OaApplyBorrowMoneyService me = new OaApplyBorrowMoneyService();
	public static final String TABLE_NAME = OaApplyBorrowMoney.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		OaApplyBorrowMoney o = me.getById(id);
    		o.delete();
    	}
	}
