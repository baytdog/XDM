package com.pointlion.mvc.admin.oa.project.expressconfirm;
...
import com.pointlion.mvc.common.model.OaProjectExpressConfirm;
...
public class OaProjectExpressConfirmController extends BaseController {
	public static final OaProjectExpressConfirmService service = OaProjectExpressConfirmService.me;
     ...
     */
    public void save(){
    	OaProjectExpressConfirm o = getModel(OaProjectExpressConfirm.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaProjectExpressConfirm o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaProjectExpressConfirm.class.getSimpleName()));//模型名称
