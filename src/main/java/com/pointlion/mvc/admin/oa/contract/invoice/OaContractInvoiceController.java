package com.pointlion.mvc.admin.oa.contract.invoice;
...
import com.pointlion.mvc.common.model.OaContractInvoice;
...
public class OaContractInvoiceController extends BaseController {
	public static final OaContractInvoiceService service = OaContractInvoiceService.me;
     ...
     */
    public void save(){
    	OaContractInvoice o = getModel(OaContractInvoice.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaContractInvoice o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaContractInvoice.class.getSimpleName()));//模型名称
