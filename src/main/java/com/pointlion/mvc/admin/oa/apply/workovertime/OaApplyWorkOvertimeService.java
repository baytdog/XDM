...
public class OaApplyWorkOvertimeService{
	public static final OaApplyWorkOvertimeService me = new OaApplyWorkOvertimeService();
	public static final String TABLE_NAME = OaApplyWorkOvertime.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		OaApplyWorkOvertime o = me.getById(id);
    		o.delete();
    	}
	}
