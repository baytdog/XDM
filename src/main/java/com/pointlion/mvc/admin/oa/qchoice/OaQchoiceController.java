...
public class OaQchoiceController extends BaseController {
	public static final OaQchoiceService service = OaQchoiceService.me;
    ...
    public void getEditPage(){
		...
		setAttr("o", o);
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaQchoice.class.getSimpleName()));
