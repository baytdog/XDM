...
public class OaMenuDictService{
	public static final OaMenuDictService me = new OaMenuDictService();
	public static final String TABLE_NAME = OaMenuDict.tableName;
