...
public class OaApplyUsercarWorkController extends BaseController {
	public static final OaApplyUsercarWorkService service = OaApplyUsercarWorkService.me;
     ...
     */
    public void save(){
    	OaApplyUsercarWork o = getModel(OaApplyUsercarWork.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyUsercarWork o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyUsercarWork.class.getSimpleName()));//模型名称
