package com.pointlion.mvc.admin.oa.apply.gift;
...
import com.pointlion.mvc.common.model.OaApplyGift;
...
public class OaApplyGiftController extends BaseController {
	public static final OaApplyGiftService service = OaApplyGiftService.me;
     ...
     */
    public void save(){
    	OaApplyGift o = getModel(OaApplyGift.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyGift o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyGift.class.getSimpleName()));//模型名称
