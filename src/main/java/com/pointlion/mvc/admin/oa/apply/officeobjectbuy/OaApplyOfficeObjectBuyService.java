...
public class OaApplyOfficeObjectBuyService{
	public static final OaApplyOfficeObjectBuyService me = new OaApplyOfficeObjectBuyService();
	public static final String TABLE_NAME = OaApplyOfficeObjectBuy.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		OaApplyOfficeObjectBuy o = me.getById(id);
    		o.delete();
    	}
	}
