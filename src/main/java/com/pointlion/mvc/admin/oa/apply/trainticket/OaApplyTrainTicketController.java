...
public class OaApplyTrainTicketController extends BaseController {
	public static final OaApplyTrainTicketService service = OaApplyTrainTicketService.me;
	static WorkFlowService wfservice = WorkFlowService.me;
	public String controllerName = "机票/火车票预定申请";
	/***
	 * 列表页面
	 */
     ...
     */
    public void save(){
    	OaApplyTrainTicket o = getModel(OaApplyTrainTicket.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaApplyTrainTicket o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaApplyTrainTicket.class.getSimpleName()));//模型名称
