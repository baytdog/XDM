package com.pointlion.mvc.admin.oa.contract.change;
...
import com.pointlion.mvc.common.model.OaContractChange;
...
public class OaContractChangeController extends BaseController {
	public static final OaContractChangeService service = OaContractChangeService.me;
     ...
     */
    public void save(){
    	OaContractChange o = getModel(OaContractChange.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		OaContractChange o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(OaContractChange.class.getSimpleName()));//模型名称
