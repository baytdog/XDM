...
public class AmsAssetDisposeService{
	public static final AmsAssetDisposeService me = new AmsAssetDisposeService();
	public static final String TABLE_NAME = AmsAssetDispose.tableName;
	...
	public void deleteByIds(String ids){
    	...
    	for(String id : idarr){
    		AmsAssetDispose o = me.getById(id);
    		o.delete();
    	}
	}
