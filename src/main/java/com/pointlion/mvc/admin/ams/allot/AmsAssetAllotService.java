...
public class AmsAssetAllotService{
	public static final AmsAssetAllotService me = new AmsAssetAllotService();
	public static final String TABLE_NAME = AmsAssetAllot.tableName;
