package com.pointlion.mvc.admin.ams.need;
...
import com.pointlion.mvc.common.model.AmsAssetNeed;
...
public class AmsAssetNeedController extends BaseController {
	public static final AmsAssetNeedService service = AmsAssetNeedService.me;
     ...
     */
    public void save(){
    	AmsAssetNeed o = getModel(AmsAssetNeed.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		AmsAssetNeed o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(AmsAssetNeed.class.getSimpleName()));//模型名称
