...
public class AmsAssetAllotController extends BaseController {
	public static final AmsAssetAllotService service = AmsAssetAllotService.me;
     ...
     */
    public void save(){
    	AmsAssetAllot o = getModel(AmsAssetAllot.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		AmsAssetAllot o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(AmsAssetAllot.class.getSimpleName()));//模型名称
