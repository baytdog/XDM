package com.pointlion.mvc.admin.ams.repair;
...
import com.pointlion.mvc.common.model.AmsAssetRepair;
...
public class AmsAssetRepairController extends BaseController {
	public static final AmsAssetRepairService service = AmsAssetRepairService.me;
     ...
     */
    public void save(){
    	AmsAssetRepair o = getModel(AmsAssetRepair.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		AmsAssetRepair o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(AmsAssetRepair.class.getSimpleName()));//模型名称
