...
public class AmsAssetReceiveController extends BaseController {
	public static final AmsAssetReceiveService service = AmsAssetReceiveService.me;
     ...
     */
    public void save(){
    	AmsAssetReceive o = getModel(AmsAssetReceive.class);
    ...
    public void getEditPage(){
    	...
    	if(StrKit.notBlank(id)){//修改
    		AmsAssetReceive o = service.getById(id);
    		setAttr("o", o);
    		//是否是查看详情页面
    	...
    	setAttr("formModelName",StringUtil.toLowerCaseFirstOne(AmsAssetReceive.class.getSimpleName()));//模型名称
